...
from phase_aware.core.losses.dice_ce_phase import DiceCEPhaseFactory
DICE_CE_PHASE_CONFIG = {"lambda_ce":0.3,"lambda_dice":0.3,"lambda_phase_align":0.4,"lambda_phase_tv":0.0}
dice_ce_loss = DiceCEPhaseFactory("dice_ce_phase_standard", **DICE_CE_PHASE_CONFIG)
print(dice_ce_loss)
