...
from phase_aware.core.losses.dice_ce_skip import DiceCESkipFactory
DICE_CE_PHASE_CONFIG = {"lambda_ce":0.5, "lambda_dice":0.5,"lambda_skip":0.01}
dice_ce_loss = DiceCESkipFactory("dice_ce_skip_standard", **DICE_CE_PHASE_CONFIG)
print(dice_ce_loss)
